...
def main(output_prefix):
    ...
    build_vocab()
    train_data = load_data('./data/train-data-processed.json', trainScriptKnowledge, args.use_script)
    train_data += load_data('./data/trial-data-processed.json', trialScriptKnowledge, args.use_script)
    dev_data = load_data('./data/dev-data-processed.json', devScriptKnowledge, args.use_script)
    if args.test_mode:
    ...
    dev_data = load_data('./data/test-data-processed.json', testScriptKnowledge, args.use_script)
