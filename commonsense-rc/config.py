...
parser.add_argument('--dropout_rnn_output', type=float, default=0.3, help='dropout for RNN output')
parser.add_argument('--rnn_padding', type='bool', default=True, help='Use padding or not')
parser.add_argument('--dropout_emb', type=float, default=0.3, help='dropout rate for embeddings')
